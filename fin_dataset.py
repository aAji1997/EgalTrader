...
class FinancialDataset(Dataset):
    def __init__(self, env, mode='train', sequence_length=5, batch_size=32, shuffle_within_sequences=False):
        self.env = env
        self.mode = mode
        ...
        self.cache_size = min(1000, len(self.dates))  # Limit cache size
